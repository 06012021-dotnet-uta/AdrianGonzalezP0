...
namespace StoreModels
{
    ...
    /// </summary>
    public class Customer : ILocation
    {
        ...
        public string Address { get; set; }            // The address where the customer lives
        public string City { get; set; }               // The City where customer lives
        public string State { get; set; }              // The State where customer lives 
        public string Zipcode { get; set; }            // The Zipcode where customer lives
        ...
        public Customer(Account Account, string Fname, string Lname, string Address, string City, string State, string Zipcode, string ContactNumber = null, string Email = null)
        {
            this.Fname = Fname;
            this.Lname = Lname;
